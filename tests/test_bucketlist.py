...
class BucketlistTestcase(unittest.TestCase):
    ...
    def login_user(self):
        self.create_user()
        logged_in = self.client.post("/api/v1/auth/login",
                                     data=json.dumps(
                                         {"username": "Christine",
                                          "password": "1234"}),
    ...
    def test_create_account_invalid_email(self):
        ...
        result = json.loads(response.data)
        self.assertEqual(
            "Email address should have 'email@example.com' format",
            result["message"])
    ...
    def test_create_account_missing_parameters(self):
        ...
        result = json.loads(response.data)
        self.assertEqual(
            "Enter the username, email address and password to create account",
            result["message"])
        self.assertEqual(response.status_code, 400)
    ...
    def test_register_username_exists(self):
        ...
        self.assertEqual(
            "User with username 'Christine' already exists",
            result["message"])
    ...
    def test_register_username_is_digit(self):
        ...
        result = json.loads(response.data)
        self.assertEqual(
            "Invalid value entered for username and / or password",
            result["message"])
    ...
    def test_view_all_bucketlists(self):
        token = self.login_user()
        add_response = self.client.post("/api/v1/bucketlists",
                                        data=json.dumps({"name":
    ...
    def test_view_all_bucketlists_none_added(self):
        ...
        result = json.loads(response.data)
        self.assertEqual(
            "You have not added any bucketlist yet",
            result["message"])
    ...
    def test_view_bucketlist_no_items_added(self):
        ...
        result = json.loads(response.data)
        self.assertIn(
            "Visit every country in the world has no items",
            str(result))
    ...
    def test_view_bucketlist_no_access(self):
        ...
        result = json.loads(response.data)
        self.assertEqual(
            "You are not authorised to view this bucketlist!",
            result['message'])
    ...
    def test_edit_bucketlist(self):
        ...
        add_response = self.client.post("/api/v1/bucketlists",
                                        ...
                                        headers={"content-type":
                                                 ...
                                                 "Bearer " + token})
        self.assertEqual(add_response.status_code, 201)
        edit_response = self.client.put("/api/v1/bucketlists/1",
                                        data=json.dumps(
                                            {"name":
    ...
    def test_edit_bucketlist_no_access(self):
        ...
        result = json.loads(edit_response.data)
        self.assertEqual(
            "You are not authorised to modify this bucketlist!",
            result['message'])
    ...
    def test_delete_bucketlist(self):
        ...
        add_response = self.client.post("/api/v1/bucketlists",
                                        ...
                                        headers={"content-type":
                                                 ...
                                                 "Bearer " + token})
        self.assertEqual(add_response.status_code, 201)
        del_response = self.client.delete("/api/v1/bucketlists/1",
                                          headers={"content-type":
                                                   "application/json",
                                                   "Authorization":
                                                   "Bearer " + token})
    ...
    def test_delete_bucketlist_no_access(self):
        ...
        result = json.loads(del_response.data)
        self.assertEqual(
            "You are not authorised to delete this bucketlist!",
            result['message'])
    ...
    def test_add_item_to_bucket(self):
        ...
        add_response = self.client.post("/api/v1/bucketlists",
                                        ...
                                        headers={"content-type":
                                                 ...
                                                 "Bearer " + token})
        self.assertEqual(add_response.status_code, 201)
        add_item_response = self.client.post("/api/v1/bucketlists/1/items",
                                             data=json.dumps(
                                                 {"name": "Indian ocean"}),
                                             headers={"content-type":
                                                      "application/json",
    ...
    def test_edit_item_in_bucket(self):
        ...
        add_item_response = self.client.post("/api/v1/bucketlists/1/items",
                                             ...
                                             headers={"content-type":
                                                      ...
                                                      "Bearer " + token})
        self.assertEqual(add_item_response.status_code, 201)
        edit_item_response = self.client.put("/api/v1/bucketlists/1/items/1",
                                             data=json.dumps(
                                                 {"name":
                                                  "The Indian Ocean"}),
                                             headers={"content-type":
    ...
    def test_remove_item_from_bucket(self):
        ...
        add_item_response = self.client.post("/api/v1/bucketlists/1/items",
                                             ...
                                             headers={
                                                 ...
                                                 "Bearer " + token})
        self.assertEqual(add_item_response.status_code, 201)
        del_item_response = self.client.delete("/api/v1/bucketlists/1/items/1",
                                               headers={"content-type":
                                                        "application/json",
                                                        "Authorization":
                                                        "Bearer " + token})
        ...
        self.assertIn(
            "Item successfully deleted from Swim in the oceans",
            str(result))
